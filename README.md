...
**Актуальная версия 0.1.5:**

- [Скачать NyaaGuard для Windows x64](https://github.com/Spirt51/NyaaGuard-Releases/releases/download/v0.1.5/NyaaGuard-Setup-0.1.5-win-x64.exe) · [SHA-256](https://github.com/Spirt51/NyaaGuard-Releases/releases/download/v0.1.5/NyaaGuard-Setup-0.1.5-win-x64.exe.sha256)
- [Скачать NyaaGuard для Debian/Ubuntu amd64](https://github.com/Spirt51/NyaaGuard-Releases/releases/download/v0.1.5/nyaaguard_0.1.5_amd64.deb) · [SHA-256](https://github.com/Spirt51/NyaaGuard-Releases/releases/download/v0.1.5/nyaaguard_0.1.5_amd64.deb.sha256)
...
```powershell
# Windows PowerShell
Get-FileHash .\NyaaGuard-Setup-0.1.5-win-x64.exe -Algorithm SHA256
```

```bash
# Linux
sha256sum -c nyaaguard_0.1.5_amd64.deb.sha256
sudo apt install ./nyaaguard_0.1.5_amd64.deb
```
